...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    if([error code] == -1009)
    {
        BSCustomAlertView* alertView = [[BSCustomAlertView alloc] initWithTitle:nil message:NSLocalizedStringWithKey(@"no_network") buttonTitles:@[NSLocalizedString(@"OK", nil)] delegate:nil];
        [alertView show];
    }
}
